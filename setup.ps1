...
$AndroidCmake = 'C:\Users\SSL\AppData\Local\Android\Sdk\cmake\3.10.2.4988404\bin\cmake.exe'

# Android-ndk path: REPLACE WITH YOUR NDK PATH!
if (Get-Variable 'ANDROID_NDK' -Scope Global -ErrorAction 'Ignore') {
    $NDK = $ANDROID_NDK
} else {
    $NDK = 'C:\Users\SSL\AppData\Local\Android\Sdk\ndk\21.1.6352462'
}
...
$PROJECT_PATH = 'D:\Android\DlibRealTImeFacedetectionandeyeblinkingwith5pointfaciallandmark'
...
# Dlib library path:
$DLIB_PATH = 'C:\Users\SSL\AppData\Local\Android\Sdk\libs_file\dlib-19.21'
...
$OPENCV_PATH='C:\Users\SSL\AppData\Local\Android\Sdk\libs_file\OpenCV-android-sdk\sdk\native'
