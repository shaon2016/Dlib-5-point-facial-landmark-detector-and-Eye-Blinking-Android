...
import com.shaon2016.dlibrealtimefacedetectionandeyeblinkingwith5pointfaciallandmark.util.mapTo

/**
 * The CameraOverlay class is placed on-top of the CameraXPreview,
...
class CameraOverlay(context: Context, attrs: AttributeSet) : View(context, attrs) {
    ...
    lateinit var preview: CameraXPreview
